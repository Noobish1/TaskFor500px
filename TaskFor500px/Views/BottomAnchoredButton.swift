...
// This is a button I use in my WeatherRules app
internal final class BottomAnchoredButton: UIControl {
    // MARK: properties
    ...
    private func setupViews(bottomInset: CGFloat) {
        ...
        add(subview: titleLabel, withConstraints: { make in
            minimumTopConstraint = make.top.greaterThanOrEqualToSuperview().offset(actualMinimumTopOffset).constraint
            idealTopConstraint = make.top.equalToSuperview().offset(actualIdealTopOffset).priority(.high).constraint
